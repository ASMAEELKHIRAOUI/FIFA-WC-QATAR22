...
<link rel="stylesheet" href="../assets/css/ticketspage.css"><link rel="stylesheet" type="text/css" href="../assets/css/styleF.css" media="print">
            ...
            <div class="col-12 col-md-11 d-flex flex-column " >
                ...
                <div class=" mt-4  d-flex justify-content-between flex-wrap  ">
                    <div class="my-3  d-flex flex-column align-items-between  ">
                        ...
                        <div><i class=" my-1 py-2 mr-2 fa-solid fa-location-dot"></i><span>location</span></div>
                        <div><i class="  text-start mr-2 fa-solid fa-calendar-days"></i><span>xx/xx/xxxx xx:xx</span></div>
                        <p class="my-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minus debitis repudiandae non! Laborum</p>
                    </div>
                </div>
            </div>
