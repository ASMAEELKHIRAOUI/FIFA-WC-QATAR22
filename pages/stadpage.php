...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/stadpage.css">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 my-1 ">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <div>Group F</div>
                            <i class="fa-solid fa-location-dot"></i> <span>Morocco</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 my-1">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <i class="fa-solid fa-location-dot"></i><spain> Doha </spain>
                        </div>
                    </div>
                </div>
